mod "aws_s3_server_access_log_detections" {
  ...
  description   = "Run detections and view dashboards for your AWS S3 server access logs to monitor and analyze access patterns, security risks, and data activity across your S3 buckets using Powerpipe and Tailpipe."
  color         = "#FF9900"
